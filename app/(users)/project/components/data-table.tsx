...
export function DataTable<TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
  ...
  return (
    <div className="w-full space-y-5">
      <div className="grid grid-cols-1 gap-2 items-center justify-between pt-4">
        <Input
        ...
        {selectedRows.length > 0 && (
          <div className="w-full">
            <Button
              variant={'outline'}
              className="border w-full border-red-500 hover:bg-red-500 hover:text-white cursor-pointer"
            >
              <UserMinus />
              Remove Permanently
            </Button>
